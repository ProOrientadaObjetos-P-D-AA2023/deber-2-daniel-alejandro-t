from mis_clases import Asignatura, AsignaturaComputacion
...
asignatura = Asignatura("Matematicas", "MAT-123", 4)

# Presentar objeto; usar el método __st__
print(asignatura)

# objeto 02
## crear objeto de AsignaturaComputacion
...
mi_asignatura = AsignaturaComputacion(nombre, codigo, creditos, lenguaje, nombre_docente)
